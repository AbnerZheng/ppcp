package assignments.week1;// Week 1
...
public class TestCountPrimes {
  public static void main(String[] args) {
    ...
    final long result = 3001134;
//    System.out.printf("Sequential result: %10d%n%n", countSequential(range));// 65320ms
    System.out.printf("Parallel2  result: %10d%n%n", countParallel2(range/2)); //42433ms
    // System.out.printf("Parallel4  result: %10d%n%n", countParallelN(range, 4));
//    System.out.printf("Parallel10 result: %10d%n%n", countParallelN(range, 10));// 27338ms
    long end = System.currentTimeMillis();
    System.out.printf("time passed %d", end - start);
  }
