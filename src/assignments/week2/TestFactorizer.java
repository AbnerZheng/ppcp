...
class TestFactorizer {
  public static void main(String[] args) {
    // final Factorizer2 factorizer2 = new StatelessFactorizer();
    // final Factorizer2 factorizer2 = new UnsafeCountingFactorizer();
    // final Factorizer2 factorizer2 = new CountingFactorizer();
    // final Factorizer2 factorizer2 = new UnsafeCachingFactorizer();
    // final Factorizer2 factorizer2 = new TooSynchronizedCachingFactorizer();
    // final Factorizer2 factorizer2 = new CachingFactorizer();
...
class VolatileCachingFactorizer implements Factorizer{
  private volatile OneValueCache cache 
    = new OneValueCache(1, new long[] { 1 });
